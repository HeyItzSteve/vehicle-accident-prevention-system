...
*/
    ...
    MAP_SPICSEnable(GSPI_BASE); // Enable SPI CS

    GPIOPinWrite(GPIOA0_BASE, 0x10, 0); // DC Pin Low
    GPIOPinWrite(GPIOA0_BASE, 0x8, 0); // CS Pin Low

    MAP_SPIDataPut(GSPI_BASE, c);
    MAP_SPIDataGet(GSPI_BASE, &temp);

    GPIOPinWrite(GPIOA0_BASE, 0x8, 0x8); // CS Pin High

    MAP_SPICSDisable(GSPI_BASE); // Disable SPI CS
...
*/
    ...
    GPIOPinWrite(GPIOA0_BASE, 0x10, 0x10); // DC Pin High
    GPIOPinWrite(GPIOA0_BASE, 0x8, 0); // CS Pin Low
